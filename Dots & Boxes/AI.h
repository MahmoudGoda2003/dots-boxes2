...
void AI(int x, int y, char lines[x+x+1][y+y+1], int moves_history[x*(x+1)*2][3], int counter, int *row, int *column, int gametype){
    int rowno = 0, columnno = 0, prohibited[x*(x+1)*2][2], p_counter = 0, found = 0;
    if (gametype == 1){
